...
namespace Clappon
{
    public class ClapponContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var productAttProp = modelBuilder.Entity<ProductAttributeProperty>();
            productAttProp.HasKey(p => p.ProductAttributePropertyId);
